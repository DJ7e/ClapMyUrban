...
MODIFY COLUMN user_password varchar(100);


ALTER TABLE service_provider
MODIFY COLUMN provider_password varchar(100);

ALTER TABLE manager
MODIFY COLUMN manager_password varchar(100);

ALTER TABLE website_admin
MODIFY COLUMN admin_password varchar(100);
